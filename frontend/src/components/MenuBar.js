        ...
        <div className="flex bg-sky-300 rounded-lg z-20">
            ...
            {/*Underline*/}
                ...
                <ComboBox aria-label="Font Family"> 
                    <div className="flex ml-2 border-2 rounded-md border-cyan-800 px-2 py-1 text-primary bg-blue-200 resize-none">
                        
                        <Input id="font-family-input" className="mr-2 p-1 bg-blue-200 resize-none" value={currentFont} onChange={(e) => setCurrentFont(e.target.value)}/>
                        <Button>
            ...
            {/*Bullet List*/}
                <button className={"ml-2 border-2 rounded-md border-cyan-800 px-2 py-2 text-primary " + (editor.isActive('bulletList')? 'bg-blue-400' : 'bg-blue-200') } onClick={() => editor.chain().focus().toggleBulletList().run()}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">

			...
			<div className="lg:flex">
				<div className="hidden lg:flex lg:flex-col mx-auto lg:mr-0 max-w-2xl lg:max-w-2xl">
					...
					<svg className="w-32 mt-6 ml-5" viewBox="0 0 47 40" xmlns="http://www.w3.org/2000/svg">
						...
						<path clipRule="evenodd" d="m26.85,30.94c0,-4.74 4.19,-8.61 9.36,-8.61s9.36,3.86 9.36,8.61s-4.19,8.61 -9.36,8.61s-9.36,-3.84 -9.36,-8.61zm12.79,-1.6a0.72,0.66 0 1 0 -1.17,-0.79l-3.11,4l-1.54,-1.42a0.72,0.66 0 0 0 -1.02,0.94l2.16,1.99a0.72,0.66 0 0 0 1.11,-0.08l3.6,-4.63l-0.02,0l0,-0.01l-0.01,0z" fill="#59ba59" fillRule="evenodd" id="svg_1"/>
					</svg>
